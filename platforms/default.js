...
sed -e '/^$/d;/\\x00/d'`,
  ...
  //startAP: 'ifconfig wlan0 10.0.0.1 && systemctl start hostapd@wlan0 && systemctl start udhcpd',
  startAP: 'ifconfig wlan0 10.0.0.1 && systemctl start hostapd@wlan0 && /home/pi/enable_wlan0_dnsmasq',

  // Stop broadcasting an AP and attempt to reconnect to local wifi
  //stopAP: 'systemctl stop udhcpd && systemctl stop hostapd@wlan0 && ifconfig wlan0 0.0.0.0',
  stopAP: '/home/pi/disable_wlan0_dnsmasq && systemctl stop hostapd@wlan0 && ifconfig wlan0 0.0.0.0',
